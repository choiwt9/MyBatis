...
function idCheck(){
    //중복 체크 버튼 클릭시 사용자가 입력한 아이디 값을 서버로 보내서
    //중복되는 데이터가 있는지 조회한 후에 결과를 받을 것임

    //1)사용가능=> 사용가능합니다. 메시지 출력, 회원가입 버튼 활성화
    //2)사용불가능=> 사용할 수없는 아이디입니다. 메시지 출력, 다시 입력할 수 있도록 유도
            ...
            if(result == "NNY"){
              ...
              $("#enroll-form button[type=submit]").removeAttr("disabled");
                ...
                alert("사용 불가능한 아이디 입니다");
                  ...
                  idEle.focus();// $("#enroll-form input[type=submit]").focus();
            }
